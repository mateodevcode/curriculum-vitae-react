...
function HistoryAcademy() {
  ...
  return (
    <div id="historial-estudios" className="flex flex-col justify-center items-start w-full lg:px-10 md:px-5 sm:px-2">
      <div className={`flex flex-row justify-start items-center cursor-pointer lg:py-4 md:py-3 sm:py-2`} onClick={onclick}>
        <BiSolidRightArrow className={`lg:text-2xl md:text-xl sm:text-base lg:mr-3 md:mr-3 sm:mr-2 text-gray-600 ${desplegar == true ? "flex" : "hidden"}`} />
        <BiSolidDownArrow className={`lg:text-2xl md:text-xl sm:text-base lg:mr-3 md:mr-3 sm:mr-2 text-gray-600 ${desplegar == true ? "hidden" : "flex"}`} />
