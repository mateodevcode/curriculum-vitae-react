  ...
  return (
    <div className="flex flex-col justify-start items-start px-5 ">
      <div className=" block  mt-12 ">
        <h3 className=" flex text-2xl items-start font-semibold py-2 hover:text-blue-700 " >
          PERFIL PROFESIONAL 
        </h3>
      </div>
      <div>
        <p className="block descripcion-about  text-justify w-auto pr-4 mt-8 text-xl ">
