    ...
    <div className="px-10 w-full mt-20 mb-40">
      ...
      <div className="w-full flex flex-wrap">
        {skillsLeguajes.map((skill) => (
            <div key={skill.id} className="flex flex-row jus items-center border-blue-700 hover:text-white hover:bg-gray-950 border-2 rounded-xl w-max px-3 py-1 m-1.5 font-semibold cursor-pointer">
